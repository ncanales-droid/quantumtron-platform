...
class XGBoostService(BaseMLService):
    ...
    def __init__(self, models_dir: str = "./data/models"):
        ...
        try:
            ...
            logger.info("✓ MLflow configurado para XGBoost (sqlite:///mlflow.db)")
    ...
    async def train(
        ...
        **kwargs
        ...
        try:
            ...
            mlflow_run_id = None
            try:
                mlflow.xgboost.autolog()  # Autologging para XGBoost

                run_name = f"xgb_{task_type}_{datetime.now().strftime('%H%M%S')}"
                ...
                with mlflow.start_run(run_name=run_name):
                    ...
                    if tune_hyperparameters:
                        ...
                        if task_type == "regression":
                            ...
                            model = XGBClassifier(
                                ...
                                n_jobs=-1,
                                verbosity=0,
                                eval_metric='logloss'  # Quitado use_label_encoder
                            )
                            model.fit(
                                X_train, y_train,
                    ...
                    if 'gain' in feature_importance:
                        for feat, imp in feature_importance['gain'].items():
            ...
            # 14. Preparar respuesta (igual que antes, más MLflow info)
            ...
            if mlflow_run_id:
                result['mlflow'] = {
                    ...
                    'ui_url': 'http://localhost:5001'  # Local UI
                }
